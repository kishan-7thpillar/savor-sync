...
export function MetricsCard({
  ...
  if (loading) {
    return (
      <Card className={cn('cursor-pointer transition-colors hover:bg-accent', onClick && 'cursor-pointer')}>
  ...
  return (
    <Card 
      className={cn('transition-colors hover:bg-accent', onClick && 'cursor-pointer')}
      onClick={onClick}
    >
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-sm font-medium">{title}</CardTitle>
